...
<body class="bg-white text-gray-900">
	...
	<main class="pt-24">
		<section id="menu">
			<h1 class="text-center text-3xl font-bold text-indigo-700">Sitio Privado de Productos</h1>
			<h4 class="text-center text-xl text-gray-700 mt-4">
				Bienvenido, <%= usuario %>
			</h4>
		</section>
	</main>
