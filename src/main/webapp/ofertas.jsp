...
<title>Choro Patin - Ofertas</title>
...
<body class="bg-white text-gray-900">
	...
	<main class="pt-24">
		<section>
			<h3 class="text-center text-3xl font-bold text-indigo-700">Ofertas</h3>
			<%
			Producto pr = new Producto();
			out.print(pr.consultarOfertas());
			%>
		</section>
		<section>
			<h3 class="text-center text-3xl font-bold text-indigo-700">Sin Ofertas</h3>
			<%
			out.print(pr.consultarSinOfertas(""));
			%>
		</section>
	</main>
