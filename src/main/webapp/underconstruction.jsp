...
<title>Choro Patin - En Construcción</title>
...
<body class="bg-white text-gray-900">
	...
	<main class="pt-24">
		<h1 class="text-center text-3xl font-bold text-indigo-700">¡Estamos en construcción!</h1>
		<p class="text-center text-gray-700 mt-4">Volveremos pronto con más contenido.</p>
	</main>
